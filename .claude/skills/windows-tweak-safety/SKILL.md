...
description: Safety rules for any code that reads or changes Windows system state — registry, services, power plans, startup items, scheduled tasks, or app removal. Use when writing, editing, or reviewing any file in SystevoTune.Engine, or any PowerShell called from it.
---
...
2. Whitelist only. Services, bloatware, and cleanup paths must come from the whitelist files in src/SystevoTune.Engine/Whitelists. Never add items inline in code.
